...
<td><a href="mylist?id=${i.pid}&name=${i.pname}&desc=${i.pdesc}&price=${i.pprice}&qty=${i.pqty}">ADD</a></td>
<td><a href="cart?id=${i.pid}">ADD</a></td>
<td><a href="purchase.jsp?id=${i.pid}&name=${i.pname}&desc=${i.pdesc}&price=${i.pprice}&qty=${i.pqty}">BUY</a></td>
</tr>
</c:forEach>
</table><br><br>
